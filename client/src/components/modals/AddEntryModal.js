...
/**
 * AddEntryModal - handles new vault entry creation
 * Single Responsibility: add entry form and submission
 */
      ...
      <ModalOverlay onClose={onClose}>
        <div className="entry-modal">
          <div className="entry-modal-header">
            ...
            <div>
              <h2 className="entry-modal-title">Add Password</h2>
              <p className="entry-modal-subtitle">Store a new credential securely</p>
            </div>
          </div>
          ...
          <div className="entry-modal-body">
            ...
            <div className="entry-modal-field">
              <label className="entry-modal-label">SITE NAME</label>
